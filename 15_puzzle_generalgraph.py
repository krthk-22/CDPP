...
class Puzzle15:
    ...
    def get_possible_moves(self):
        ...
        if curr_cell + 4 in self.graph[curr_cell]:
    ...
    def draw_board(self):
        ...
        for cell in range(1, 17):
            ...
            for adj in self.graph[cell]:
                ...
                endX -= dx/4
                endY -= dy/4
                draw_arrow(startX + dx/4, startY + dy/4, endX, endY, (255, 0, 0))
